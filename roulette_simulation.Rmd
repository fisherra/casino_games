...
examine <- vector("double", length(roulette_ten))

for (i in seq_along(roulette_ten)) {
  # Each gambler places a bet
  gambler_a_cash = gambler_a_cash - 10
  gambler_b_cash = gambler_b_cash - 10 
  gambler_c_cash = gambler_c_cash - 10
  # 
  if (roulette_ten[[i]] == 1) 
    gambler_a_cash = gambler_a_cash + 1000
  #examine[[i]] <- cumsum(roulette_ten[[i]])
}
